...
| `yopoAvoidBrakeRange` / `BrakeRangeHi` | 24.0 / 54.0 | Progressive soft-brake zone (m): low / high speed (raised together with `yopoAvoidStopH` 6→7.5 so the `(brakeClear − standoff×2)` normalisation does not degenerate) |
